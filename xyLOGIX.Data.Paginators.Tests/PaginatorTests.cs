...
{
   /// <summary>
   /// Provides unit tests for the <see
   ...
   public class PaginatorTests
   {
      ...
      {
         Assert.AreEqual(_paginator.GoToPage(int.MinValue), _paginator.First());
         Reset();
      }
      ...
      {
         Assert.AreEqual(_paginator.GoToPage(int.MaxValue), _paginator.Last());
         Reset();
      }
      ...
      {
         Assert.AreEqual(VALID_COINMARKETCAP_FINAL_PAGE_URL, _paginator.Last());
         Reset();
      }
      ...
      /// <summary>
      /// Asserts the <see
      /// cref="P:xyLOGIX.Data.Paginators.Interfaces.IPaginator.PageUrl"/>
      ...
      public void Test_Page10_URL_HasCorrectFormat()
      {
         ...
         Assert.AreEqual(VALID_COINMARKETCAP_PAGE_10_URL, _paginator.PageUrl);
         Reset();
      }
      ...
      /// <summary>
      /// Handles the <see
      /// cref="E:xyLOGIX.Data.Paginators.Interfaces.IPaginator.PageChanged"/> event.
      /// </summary>
      /// <param name="sender">
