...
namespace xyLOGIX.Data.Paginators.Factories
{
    ...
    public static class GetScrapedDataPaginator
    {
        ...
        /// for the
        /// <see cref="T:xyLOGIX.Data.Paginators.Factories.GetScrapedDataPaginator" />
        /// class.
        /// </summary>
        /// <remarks>
        ...
        static GetScrapedDataPaginator() { }

        /// <summary>
        /// Creates an instance of an object implementing the
        /// <see cref="T:xyLOGIX.Data.Paginators.Interfaces.IScrapedDataPaginator" />
        /// interface which corresponds to the value specified in <paramref name="type" />,
        /// and returns a reference to it.
        /// </summary>
        /// <param name="type">
        /// One of the
        /// <see cref="T:xyLOGIX.Data.Paginators.Factories.PaginatorType" /> values that
        ...
        /// <see cref="T:xyLOGIX.Data.Paginators.Interfaces.IScrapedDataPaginator" />
        /// interface and which corresponds to the value passed in the
        ...
        public static IScrapedDataPaginator OfType(PaginatorType type)
        {
            ...
            DebugUtils.WriteLine(
                DebugLevel.Debug, "In GetScrapedDataPaginator.OfType"
            );

            // Dump the parameter type to the log
            DebugUtils.WriteLine(
                DebugLevel.Debug,
                $"GetScrapedDataPaginator.OfType: type = '{type}'"
            );
