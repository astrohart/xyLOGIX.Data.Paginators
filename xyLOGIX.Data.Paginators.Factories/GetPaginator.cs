...
namespace xyLOGIX.Data.Paginators.Factories
{
   ...
   /// cref="T:xyLOGIX.Data.Paginators.Interfaces.IPaginator"/> interface.
   /// </summary>
   public static class GetPaginator
   {
      /// <summary>
      /// Creates an instance of an object implementing the <see
      /// cref="T:xyLOGIX.Data.Paginators.Interfaces.IPaginator"/> interface
      ...
      /// <param name="type">
      /// One of the <see
      /// cref="T:xyLOGIX.Data.Paginators.Factories.PaginatorType"/> values that
      /// describes what type of object you want.
      /// </param>
      /// <returns>
      /// A reference to the instance of the object that implements the <see
      /// cref="T:xyLOGIX.Data.Paginators.Interfaces.IPaginator"/> interface
      /// which corresponds to the value specified in <paramref name="type"/>.
      /// </returns>
      /// <remarks>
      ...
      /// which corresponds to the value passed in the <paramref name="type"/> parameter.
      /// </exception>
      public static IPaginator OfType(PaginatorType type)
      {
         ...
         DebugUtils.WriteLine(DebugLevel.Debug, $"GetPaginator.OfType: type = '{type}'");
