...
namespace xyLOGIX.Data.Paginators.Models
{
   ...
   public sealed class Pagination
   {
      ...
      /// cref="T:xyLOGIX.Data.Paginators.Pagination"/> and returns a reference
      /// to it.
      /// </summary>
      /// <remarks>
      /// Call this constructor when calling the constructor of one of the
      /// family of classes that implement <see
      ...
      /// <summary>
      /// Constructs a new instance of <see
      /// cref="T:xyLOGIX.Data.Paginators.Models.Pagination"/> and returns a
      /// reference to it.
      /// </summary>
      /// ///
      /// <param name="currentPage">
      /// (Required.) Integer specifying the number of the current page. Set to
      ...
      /// (Required.) Integer specifying the total entries in the entire (paged)
      /// list. This value must be zero or greater.
      /// </param>
      /// <exception cref="T:System.ArgumentOutOfRangeException">
      /// Thrown if the <paramref name="currentPage"/> parameter is less than 1,
      /// or either of the <paramref name="pageSize"/> or <paramref
      /// name="totalEntries"/> parameters are less than zero.
      /// </exception>
