...
namespace xyLOGIX.Data.Paginators
{
   ...
   public sealed class UrlBasedPaginator : PaginatorBase, IUrlPaginator
   {
      ...
      /// cref="T:xyLOGIX.Data.Paginators.UrlBasedPaginator"/> and returns a
      /// reference to it.
      /// </summary>
      ...
      /// (Required.) Reference to an instance of a <see
      ...
      public override int CurrentPage
      {
         ...
         get { return Pagination.CurrentPage; }
      }
      ...
      public override string GoToPage(int page)
      {
         lock (SyncRoot)
         {
            ...
            ) // we're already at the desired page.
            {
